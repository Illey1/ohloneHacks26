...
function FAQ() {
    ...
    const faqData = [
        ...
        { question: "Is it overnight?", answer: "Unfortunately not. However, it is a 2-day event where most hacking can be done in-person on Friday and early morning Saturday. Judging is set for around afternoon on Saturday." },
        ...
        { question: "What can I build?", answer: "We will have three different tracks that tackle different challenges. You are free to choose from any one of them on the event day!" },
